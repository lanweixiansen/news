...
public class MilitaryViewModel extends AndroidViewModel {
  MutableLiveData<List<AVObject>> mLiveData;
  private final NewsRepository mRepository;

  public MilitaryViewModel(@NonNull Application application) {
    super(application);
  ...
  public void requestData(){
    ...
    avQuery.whereStartsWith("article_type", "军事");
