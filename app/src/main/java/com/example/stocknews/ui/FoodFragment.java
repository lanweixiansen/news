...
import com.example.stocknews.ViewModel.FootViewModel;
import com.example.stocknews.ViewModel.TechnologyViewModel;
import com.example.stocknews.adapter.NewsAdapter;
import com.example.stocknews.databinding.FragmentFoodBinding;
 ...
 * 美食
 */
public class FoodFragment extends BaseFragment2<FragmentFoodBinding> {
  ...
  private void initView() {
    mViewModel = new ViewModelProvider(requireActivity()).get(FootViewModel.class);
