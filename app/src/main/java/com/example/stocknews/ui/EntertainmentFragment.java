...
import com.example.stocknews.ViewModel.EntertainmentViewModel;
import com.example.stocknews.ViewModel.NewsViewModel;
import com.example.stocknews.adapter.NewsAdapter;
import com.example.stocknews.databinding.FragmentEducationBinding;
import com.example.stocknews.databinding.FragmentEntertainmentBinding;
 ...
 * 娱乐
 */
public class EntertainmentFragment extends BaseFragment2<FragmentEntertainmentBinding> {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    SlidingTabLayout tabLayout = getActivity().findViewById(R.id.news_tab);
  ...
  private void initView() {
    mViewModel = new ViewModelProvider(requireActivity()).get(EntertainmentViewModel.class);
