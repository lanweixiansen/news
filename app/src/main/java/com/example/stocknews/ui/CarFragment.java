...
import com.example.stocknews.ViewModel.CarViewModel;
import com.example.stocknews.ViewModel.TechnologyViewModel;
import com.example.stocknews.adapter.NewsAdapter;
import com.example.stocknews.databinding.FragmentCarBinding;
...
public class CarFragment extends BaseFragment2<FragmentCarBinding> {
  ...
  private void initView() {
    mViewModel = new ViewModelProvider(requireActivity()).get(CarViewModel.class);
