...
import com.example.stocknews.ViewModel.MoneyViewModel;
import com.example.stocknews.ViewModel.TechnologyViewModel;
import com.example.stocknews.adapter.NewsAdapter;
import com.example.stocknews.databinding.FragmentMoneyBinding;
 ...
 * 财经
 */
public class MoneyFragment extends BaseFragment2<FragmentMoneyBinding> {
  ...
  private void initView() {
    mViewModel = new ViewModelProvider(requireActivity()).get(MoneyViewModel.class);
