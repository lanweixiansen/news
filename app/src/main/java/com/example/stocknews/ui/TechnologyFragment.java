...
import com.example.stocknews.databinding.FragmentTechnologyBinding;
 ...
 * 科技
 */
public class TechnologyFragment extends BaseFragment2<FragmentTechnologyBinding> {
  ...
  private void initView() {
    mViewModel = new ViewModelProvider(requireActivity()).get(TechnologyViewModel.class);
